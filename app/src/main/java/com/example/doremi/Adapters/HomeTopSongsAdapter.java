...
public class HomeTopSongsAdapter extends RecyclerView.Adapter<HomeTopSongsAdapter.ViewHolder> {

    final int itemsCountLimit = 3;
    LayoutInflater inflater;
    List<Song> songs;

    public HomeTopSongsAdapter(Context ctx, List<Song> songs) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.home_song_item_layout, parent, false);
        return new HomeTopSongsAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull @NotNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(holder.itemView).navigate(R.id.action_nav_home_to_playerFragment, bundle);
            }
        });
    }
    ...
    public int getItemCount() {
        if (songs.size() > itemsCountLimit) {
            return itemsCountLimit;
        } else {
            return songs.size();
        }
    }
